...
CAP=lambda e: e.replace('/assets','/cap')
CA, CB, CC, CD, CE, CF = CAP(TXA), CAP(AOL), CAP(DPQ), CAP(ANO), CAP(TXP), CAP(MIB)
C = [
 ('w133_a', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + {G(CD)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w133_b', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + {G(CE)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w133_c', f'1.75*{G(CA)} + {G(CB)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w133_d', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=5)),
 ('w133_e', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=7)),
 ('w133_f', f'1.5*{G(CA)} + {G(CE)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w133_g', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + {G(CF)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w133_h', f'1.5*{G(CA)} + {G(CB)} + {G(CD)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ]
