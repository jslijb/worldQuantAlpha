...
> **归档信息**
> - 页面：<https://platform.worldquantbrain.com/learn/documentation/data>
> - 页面 id：`data` ｜ 课程：`Data` ｜ 预计时长：PT4M
> - 平台最后更新：2026-08-26T01:56:48.752644-04:00
...
![vector desc.png](../images/data/01_vector_desc.png)
...
| 3 | ts_std_dev(datafield,N) != 0 ? 1 : 0 | Frequency of unique data (daily, weekly, monthly etc.).
