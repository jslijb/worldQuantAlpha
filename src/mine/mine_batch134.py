...
C = [
 ('w134_a', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + {G(CF)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=7)),
 ('w134_b', f'1.5*{G(CA)} + {G(CB)} + {G(CC)} + 0.9*{PVD5} + 0.9*{VOL12}', BASE(delay=7)),
 ('w134_c', f'1.5*{G(TXA)} + {G(CB)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=6)),
 ('w134_d', f'1.75*{G(CA)} + {G(CB)} + {G(CC)} + 0.75*{PVD5} + 0.75*{VOL12}', BASE(delay=7)),
 ]
